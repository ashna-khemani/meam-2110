...
problem1116 = os.path.join("assignments", "project5", "problem_15_8.py")
output1116 = os.path.join("assignments", "project5", "problem_15_8_result.txt")
...
'''
with zipfile.ZipFile(os.path.join(os.getcwd(), "assignments", "project5_submission.zip"), mode="w") as archive:
