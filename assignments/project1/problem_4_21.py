...
# YOUR CODE GOES HERE
system.AddJoint(PARENT, CHILD, JointType.rotation, UnitVector.z)
system.AddJoint(PARENT, CHILD, JointType.rotation, UnitVector.z)
system.AddJoint(PARENT, CHILD, JointType.rotation, UnitVector.z)
...
r_Ao_Bo_N = # YOUR CODE HERE!

r_Bo_Bc_N = # YOUR CODE HERE!

r_Bc_Co_N = # YOUR CODE HERE!

r_Co_Ao_N = # YOUR CODE HERE!
